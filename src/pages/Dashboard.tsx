    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-24 md:pb-8">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="fixed bottom-8 right-8 flex flex-col items-end gap-3 z-50">
          ...
          }, onSaveSuccess)} className="flex items-center justify-center w-12 h-12 bg-white rounded-full shadow-lg border hover:bg-slate-50 transition-colors" title="Guardar Valuación"><Save className="w-5 h-5 text-slate-600" /></button>
          <PDFGenerator
            tipo="tasacion"
            data={{
            ...
            theme={pdfTheme}
            displayMode="text"
            className="flex items-center gap-2 px-6 py-4 bg-indigo-600 text-white rounded-full shadow-xl hover:bg-indigo-700 hover:scale-105 transition-all font-bold text-sm tracking-wide"
          />
        </div>
      </main>
    </div>

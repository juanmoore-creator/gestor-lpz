            ...
            <div className="flex-1">
                {conversations.length === 0 ? (
                    ...
                    conversations.map((conv) => {
                        const linkedClient = conv.clientId ? getClientById(conv.clientId) : null;
                        const displayName = linkedClient ? linkedClient.name : (conv.contactName || conv.contactPhoneNumber);
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={clsx(
                                    ...
                                    linkedClient ? "bg-blue-100 text-blue-600" : "bg-slate-100 text-slate-400"
                                )}>
                                    <User size={24} />
                                </div>
                                ...
                                <div className="flex-1 min-w-0 text-left">
                                    <div className="flex justify-between items-start mb-0.5">
                                        <h3 className={clsx(
                                            ...
                                            linkedClient ? "text-blue-900" : "text-slate-800"
                                        )}>
                                            {displayName}
                                        </h3>
